...
<div>
  <h2>Ciao {{Auth::user()->name}}, hai già pensato di mettere in risalto il tuo appartamento? </h2>
</div>
<div>
 ...
 @method('POST')
  ...
  <input type="submit" value="Paga" class="hidden" class="btn btn-primary" id="bottone">
</div>
</form>
@endif
